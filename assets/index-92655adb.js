...
`,ee=document.documentElement.clientWidth*.9,_e=document.documentElement.clientHeight*.9;let $=0,le=0,k=130;const We=-23.5,je=10;let ge=0,de=0;const ke=f(0,0,2.5),qe=f(0,0,1.5),He=f(0,1,0),m=new ve(ee,_e),j=new oe(m.gl,Ne,Xe),$e=m.gl.getUniformLocation(j.id,"model"),Ke=m.gl.getUniformLocation(j.id,"projection"),Ze=m.gl.getUniformLocation(j.id,"view"),Je=m.gl.getUniformLocation(j.id,"viewPosition"),te=new oe(m.gl,Ye,Ge),Qe=m.gl.getUniformLocation(te.id,"projection"),et=m.gl.getUniformLocation(te.id,"view"),z=document.getElementById("play");z==null||z.addEventListener("click",()=>{v.play(),z.hidden=!0});const W={cubemapImages:!1,videoLoaded:!1};function K(){W.cubemapImages&&W.videoLoaded&&(document.getElementById("loader").style.display="none",z.hidden=!1)}let ie=!1,Z,J;const I=/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),tt=I?"touchstart":"mousedown",it=I?"touchmove":"mousemove",nt=I?"touchend":"mouseup";document.addEventListener(tt,e=>{ie=!0,Z=I?e.touches[0].clientX:e.clientX,J=I?e.touches[0].clientY:e.clientY});document.addEventListener(it,e=>{if(ie){const t=I?e.touches[0].clientX:e.clientX,r=I?e.touches[0].clientY:e.clientY,i=t-Z,n=r-J;ge+=n/10,de+=i/10,Z=t,J=r,e.preventDefault()}});document.addEventListener(nt,()=>{ie=!1});const v=document.createElement("video");v.src="https://waynechoidev.github.io/earth-animation/sphere.mp4";v.crossOrigin="anonymous";const fe=new Oe(m.gl);v.addEventListener("loadedmetadata",()=>{v.currentTime=.1,fe.initialise(v),W.videoLoaded=!0,K()});v.load();v.addEventListener("ended",()=>{v.currentTime=.1,v.play()});const me=new ze(m.gl,20);me.initialise();const ue=new Ve(m.gl),rt=["https://waynechoidev.github.io/earth-animation/cubemap/px.png","https://waynechoidev.github.io/earth-animation/cubemap/nx.png","https://waynechoidev.github.io/earth-animation/cubemap/py.png","https://waynechoidev.github.io/earth-animation/cubemap/ny.png","https://waynechoidev.github.io/earth-animation/cubemap/pz.png","https://waynechoidev.github.io/earth-animation/cubemap/nz.png"],st=async()=>{const e=rt.map(t=>new Promise((r,i)=>{const n=new Image;n.onload=()=>{r(n),W.cubemapImages=!0,K()},n.onerror=()=>{i(new Error("Image loading failed")),W.cubemapImages=!0,K()},n.src=t,n.crossOrigin="anonymous"}));try{const t=await Promise.all(e);ue.initialise(t)}catch(t){console.error("Error loading cubemap images:",t)}};st();const Ee=new Fe(m.gl,ee>=500?.6:.4);Ee.initialise();const Q=y();Me(Q,V(45),ee/_e,.1,100);function pe(e){m.clear(),$=(e-le)*.002,le=e,v.paused||(k>=360?k=0:k+=$*je),j.use();const t=y();Re(t,t,V(We)),re(t,t,V(k));const r=y(),i=y();re(i,i,V(de)),Ae(i,i,V(ge));const n=A(),s=A(),l=A();G(n,ke,i),G(s,qe,i),G(l,He,i),Pe(r,n,s,l),m.gl.uniformMatrix4fv($e,!1,t),m.gl.uniformMatrix4fv(Ze,!1,r),m.gl.uniformMatrix4fv(Ke,!1,Q),m.gl.uniform3f(Je,n[0],n[1],n[2]),v.readyState===v.HAVE_ENOUGH_DATA&&(fe.update(v),Ee.draw()),te.use(),m.gl.uniformMatrix4fv(et,!1,r),m.gl.uniformMatrix4fv(Qe,!1,Q),ue.use(),me.draw(),m.gl.useProgram(null),m.gl.bindTexture(m.gl.TEXTURE_2D,null),window.requestAnimationFrame(pe)}pe($);
