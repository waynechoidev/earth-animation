...
`,ee=document.documentElement.clientWidth*.9,ge=document.documentElement.clientHeight*.9;let K=0,le=0,W=130;const je=-23.5,We=10;let _e=0,de=0;const ke=f(0,0,2.5),qe=f(0,0,1.5),He=f(0,1,0),m=new ve(ee,ge),j=new oe(m.gl,Ve,Xe),$e=m.gl.getUniformLocation(j.id,"model"),Ke=m.gl.getUniformLocation(j.id,"projection"),Ze=m.gl.getUniformLocation(j.id,"view"),Je=m.gl.getUniformLocation(j.id,"viewPosition"),te=new oe(m.gl,Ye,Ge),Qe=m.gl.getUniformLocation(te.id,"projection"),et=m.gl.getUniformLocation(te.id,"view"),z=document.getElementById("play");z==null||z.addEventListener("click",()=>{v.play(),z.hidden=!0});const k={cubemapImages:!1,videoLoaded:!1};function q(){k.cubemapImages&&k.videoLoaded&&(document.getElementById("loader").style.display="none",z.hidden=!1)}let ie=!1,Z,J;const I=/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),tt=I?"touchstart":"mousedown",it=I?"touchmove":"mousemove",nt=I?"touchend":"mouseup";document.addEventListener(tt,e=>{ie=!0,Z=I?e.touches[0].clientX:e.clientX,J=I?e.touches[0].clientY:e.clientY});document.addEventListener(it,e=>{if(ie){const t=I?e.touches[0].clientX:e.clientX,r=I?e.touches[0].clientY:e.clientY,i=t-Z,n=r-J;_e+=n/10,de+=i/10,Z=t,J=r,e.preventDefault()}});document.addEventListener(nt,()=>{ie=!1});const v=document.createElement("video");v.src="https://waynechoidev.github.io/earth-animation/sphere.mp4";v.crossOrigin="anonymous";v.addEventListener("ended",()=>{v.currentTime=.1,v.play()});v.load();const fe=new Oe(m.gl),rt=async()=>new Promise((e,t)=>{v.addEventListener("loadedmetadata",()=>{v.currentTime=.1,fe.initialise(v)}),v.addEventListener("canplaythrough",()=>{e(),k.videoLoaded=!0,q()}),v.addEventListener("error",()=>{t(new Error("Video loading failed")),q()})}),me=new ze(m.gl,20);me.initialise();const ue=new Ne(m.gl),st=["https://waynechoidev.github.io/earth-animation/cubemap/px.jpg","https://waynechoidev.github.io/earth-animation/cubemap/nx.jpg","https://waynechoidev.github.io/earth-animation/cubemap/py.jpg","https://waynechoidev.github.io/earth-animation/cubemap/ny.jpg","https://waynechoidev.github.io/earth-animation/cubemap/pz.jpg","https://waynechoidev.github.io/earth-animation/cubemap/nz.jpg"],lt=async()=>{const e=st.map(t=>new Promise((r,i)=>{const n=new Image;n.src=t,n.crossOrigin="anonymous",n.onload=()=>{r(n),k.cubemapImages=!0,q()},n.onerror=()=>{i(new Error("Image loading failed")),q()}}));try{const t=await Promise.all(e);ue.initialise(t)}catch(t){console.error("Error loading cubemap images:",t)}},Ee=new Fe(m.gl,ee>=500?.6:.4);Ee.initialise();const Q=y();Me(Q,N(45),ee/ge,.1,100);function pe(e){m.clear(),K=(e-le)*.002,le=e,v.paused||(W>=360?W=0:W+=K*We),j.use();const t=y();Re(t,t,N(je)),re(t,t,N(W));const r=y(),i=y();re(i,i,N(de)),Ae(i,i,N(_e));const n=A(),s=A(),l=A();G(n,ke,i),G(s,qe,i),G(l,He,i),we(r,n,s,l),m.gl.uniformMatrix4fv($e,!1,t),m.gl.uniformMatrix4fv(Ze,!1,r),m.gl.uniformMatrix4fv(Ke,!1,Q),m.gl.uniform3f(Je,n[0],n[1],n[2]),v.readyState===v.HAVE_ENOUGH_DATA&&(fe.update(v),Ee.draw()),te.use(),m.gl.uniformMatrix4fv(et,!1,r),m.gl.uniformMatrix4fv(Qe,!1,Q),ue.use(),me.draw(),m.gl.useProgram(null),m.gl.bindTexture(m.gl.TEXTURE_2D,null),window.requestAnimationFrame(pe)}const ot=async()=>{await lt(),await rt(),pe(K)};ot();
