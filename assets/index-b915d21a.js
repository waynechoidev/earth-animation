...
`,J=document.documentElement.clientWidth*.9,ae=document.documentElement.clientHeight*.9;let H=0,re=0,W=130;const Ye=-23.5,Ge=10;let he=0,_e=0;const We=d(0,0,2.5),je=d(0,0,1.5),ke=d(0,1,0),m=new ue(J,ae),G=new se(m.gl,Oe,Fe),qe=m.gl.getUniformLocation(G.id,"model"),He=m.gl.getUniformLocation(G.id,"projection"),$e=m.gl.getUniformLocation(G.id,"view"),Ke=m.gl.getUniformLocation(G.id,"viewPosition"),Q=new se(m.gl,Ve,ze),Ze=m.gl.getUniformLocation(Q.id,"projection"),Je=m.gl.getUniformLocation(Q.id,"view");let ee=!1,$,K;const I=/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),Qe=I?"touchstart":"mousedown",et=I?"touchmove":"mousemove",tt=I?"touchend":"mouseup";document.addEventListener(Qe,e=>{ee=!0,$=I?e.touches[0].clientX:e.clientX,K=I?e.touches[0].clientY:e.clientY});document.addEventListener(et,e=>{if(ee){const t=I?e.touches[0].clientX:e.clientX,n=I?e.touches[0].clientY:e.clientY,i=t-$,r=n-K;he+=r/10,_e+=i/10,$=t,K=n,e.preventDefault()}});document.addEventListener(tt,()=>{ee=!1});const j=document.getElementById("play");j==null||j.addEventListener("click",()=>{v.play(),j.hidden=!0});const v=document.createElement("video");v.src="https://waynechoidev.github.io/earth-animation/sphere.mp4";v.crossOrigin="anonymous";const ge=new De(m.gl);v.addEventListener("loadedmetadata",()=>{v.currentTime=.1,ge.initialise(v)});v.load();v.addEventListener("ended",()=>{v.currentTime=.1,v.play()});const fe=new Ne(m.gl,20);fe.initialise();const de=new Xe(m.gl);de.initialise(["https://waynechoidev.github.io/earth-animation/cubemap/px.png","https://waynechoidev.github.io/earth-animation/cubemap/nx.png","https://waynechoidev.github.io/earth-animation/cubemap/py.png","https://waynechoidev.github.io/earth-animation/cubemap/ny.png","https://waynechoidev.github.io/earth-animation/cubemap/pz.png","https://waynechoidev.github.io/earth-animation/cubemap/nz.png"]);const me=new Ce(m.gl,J>=500?.6:.4);me.initialise();const Z=y();Re(Z,V(45),J/ae,.1,100);function Ee(e){m.clear(),H=(e-re)*.002,re=e,v.paused||(W>=360?W=0:W+=H*Ge),G.use();const t=y();ye(t,t,V(Ye)),ie(t,t,V(W));const n=y(),i=y();ie(i,i,V(_e)),xe(i,i,V(he));const r=A(),s=A(),l=A();Y(r,We,i),Y(s,je,i),Y(l,ke,i),be(n,r,s,l),m.gl.uniformMatrix4fv(qe,!1,t),m.gl.uniformMatrix4fv($e,!1,n),m.gl.uniformMatrix4fv(He,!1,Z),m.gl.uniform3f(Ke,r[0],r[1],r[2]),v.readyState===v.HAVE_ENOUGH_DATA&&(ge.update(v),me.draw()),Q.use(),m.gl.uniformMatrix4fv(Je,!1,n),m.gl.uniformMatrix4fv(Ze,!1,Z),de.use(),fe.draw(),m.gl.useProgram(null),m.gl.bindTexture(m.gl.TEXTURE_2D,null),window.requestAnimationFrame(Ee)}Ee(H);
